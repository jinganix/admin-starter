...
function ChartTooltipContent({
  ...
  labelKey?: string;
  active?: boolean;
  payload?: TooltipContentProps<TooltipValueType, TooltipNameType>["payload"];
  label?: TooltipContentProps<TooltipValueType, TooltipNameType>["label"];
} & Omit<
    RechartsPrimitive.DefaultTooltipContentProps<TooltipValueType, TooltipNameType>,
    "accessibilityLayer" | "label" | "payload"
  >): React.JSX.Element | null {
