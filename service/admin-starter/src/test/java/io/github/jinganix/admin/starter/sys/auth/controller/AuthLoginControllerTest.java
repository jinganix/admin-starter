...
class AuthLoginControllerTest extends SpringBootIntegrationTests {
  ...
  class WhenRequestIsInvalid {
    ...
    class WhenUsernameIsTooShort {
      ...
      void thenResponseError() throws Exception {
        testHelper
            .request(new AuthLoginRequest("", "aaaaaa"))
            .andExpect(status().isBadRequest())
            .andExpect(testHelper.isError(ErrorCode.BAD_REQUEST));
      }
    }
    ...
    class WhenUsernameIsTooLong {
      ...
      void thenResponseError() throws Exception {
        ...
        testHelper
            .request(new AuthLoginRequest(username, "aaaaaa"))
            .andExpect(status().isBadRequest())
            .andExpect(testHelper.isError(ErrorCode.BAD_REQUEST));
      }
    }
    ...
    class WhenPasswordIsNull {
      ...
      void thenResponseError() throws Exception {
        testHelper
            .request(new AuthLoginRequest("aaaaaa", null))
            .andExpect(status().isBadRequest())
            .andExpect(testHelper.isError(ErrorCode.BAD_REQUEST));
      }
    }
    ...
    class WhenPasswordIsTooLong {
      ...
      void thenResponseError() throws Exception {
        ...
        testHelper
            .request(new AuthLoginRequest("aaaaaa", password))
            .andExpect(status().isBadRequest())
            .andExpect(testHelper.isError(ErrorCode.BAD_REQUEST));
      }
    }
